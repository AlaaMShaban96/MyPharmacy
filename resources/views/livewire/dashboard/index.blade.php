                ...
                <a href="{{ url('admin/users') }}">
                    <div class="card card-stats">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <h5 class="card-title text-uppercase text-muted mb-0"> الزبائن</h5>
                                    <span
                                        class="h2 font-weight-bold mb-0">{{ $users->where('status', 1)->where('pharmacy_id', null)->count() }}</span>
                                </div>
                                <div class="col-auto">
                    ...
                    <div class="card-body">
                        ...
                        <div class="chart">
                            ...
                            <canvas id="chart-bars" class="chart-canvas chartjs-render-monitor"
                                style="display: block; width: 334px; height: 350px;" width="334"
                                height="350"></canvas>
                        </div>
                    </div>
                </div>
...
<script></script>
<script>
    var months = @json($months, JSON_PRETTY_PRINT);
</script>
