    ...
    <div class="row">
        ...
        <div class="col">
            ...
            <div class="card-header border-0 ">
                <h3 class="mb-0 text-center">الزبائن المسجلين في النظام</h3>
            </div>
            <!-- Light table -->
                ...
                <table class="table align-items-center table-flush">
                    <thead class="thead-light">
                        <tr>
                            ...
                            <th scope="col" class="sort" data-sort="name">اسم الزبون</th>
                            <th scope="col" class="sort" data-sort="name">الصورة</th>
                            <th scope="col" class="sort" data-sort="name">رقم الزبون</th>
                        </tr>
                    </thead>
                    <tbody class="list">
                                ...
                                <td>
                                    <span class="badge badge-dot">
                                        ...
                                        <button type="button" class="btn btn-danger "
                                            wire:click="destroy({{ $user->id }})">حذف</button>
                                    </span>
                                </td>
                                <td class="budget">
                                    {{ $user->orders->count() }}
                                ...
                                <th scope="row">
                                    <a href="#" class="avatar ">
                                        <img alt="Image placeholder" style="height: 100%;"class=""
                                            src="{{ isset($user->image) ? asset($user->image) : asset('assets/img/theme/team-1.jpg') }}">
                                    </a>
                                </th>
                                <th scope="row">
                                    {{ $user->id }}
