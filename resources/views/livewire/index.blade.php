                        ...
                        <a href="{{ url('/records') }}">
                            <div class="card card-stats">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            <h5 class="card-title text-uppercase text-muted mb-0">الطلبات التي تم الرد
                                                علىها</h5>
                        ...
                        <a href="{{ url('/my-oreders') }}">
                            <div class="card card-stats">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            <h5 class="card-title text-uppercase text-muted mb-0">الطلبات الخاصة</h5>
                                            <span
                                                class="h1 font-weight-bold mb-0">{{ auth()->user()->pharmacy->orders()->wherePivot('text', null)->count() }}</span>
                                        </div>
                                        <div class="col-auto">
                                            <div
                                                class="icon icon-shape bg-gradient-orange text-white rounded-circle shadow">
                            ...
                            <tbody class="list">
                                @foreach ($orders as $key => $order)
                                    <tr>
                                        ...
                                        <form
                                            wire:submit.prevent="replayOrder({{ $order->id }},{{ $key }})"
                                            method="post">
                                            @csrf
                                            <td>
                                                <div class="avatar-group">
                                                    <input placeholder="سعر الدواء"
                                                        ...
                                                        type="number" step="0.001" name="price" id="">
                                                </div>
                                            </td>
                                            <td>
                                                <div>
                                                    <textarea placeholder="كتابة الرد" wire:model.lazy='order.{{ $key }}.text' rows="1" name="text"
                                                        id="">
                          </textarea>
                                                </div>
                                            </td>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <img src="" alt="" srcset="" id="order-img-url"
